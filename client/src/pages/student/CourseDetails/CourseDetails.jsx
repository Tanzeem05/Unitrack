...
//             }
//           />
//           <Route path="assignments" element={<Assignments courseCode={course.course_code} />} />          <Route path="announcements" element={<h2>Announcements content here</h2>} />
//           <Route path="discussions" element={<h2>Discussions content here</h2>} />
//           <Route path="messages" element={<h2>Messages content here</h2>} />
    ...
    <div>
      ...
      <div className="p-4 bg-gray-800 rounded-lg">
        <Routes>
          ...
          <Route path="announcements" element={<h2>Announcements content here</h2>} />
          <Route path="discussions" element={<h2>Discussions content here</h2>} />
          <Route path="messages" element={<h2>Messages content here</h2>} />
          <Route path="resources" element={<h2>Resources content here</h2>} />
          <Route path="results" element={<h2>Results content here</h2>} />
