...
export default function Messages() {
  ...
  const searchUsers = async (query) => {
    ...
    try {
      const response = await api(`/messages/search-users?query=${encodeURIComponent(query)}&userType=${userTypeFilter}&batchYear=${batchYearFilter}`);
      ...
      <div className="w-1/3 border-r border-slate-700 flex flex-col">
                  ...
                  {userSuggestions.map(user => (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-600 rounded-full flex items-center justify-center text-sm font-medium">
        ...
        <div className="flex-1 overflow-y-auto">
          {conversations.map(conversation => (
            ...
            >
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-600 rounded-full flex items-center justify-center text-sm font-medium">
                ...
                >
                  ...
                  >
                    ...
                    <p className={`text-xs mt-1 ${
                      message.sender_username === user.username ? 'text-purple-200' : 'text-slate-400'
                    }`}>
            ...
            <div className="p-4 border-t border-slate-700">
              <div className="flex space-x-3">
                ...
                <button
                  ...
                  className="bg-purple-600 hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed px-6 py-2 rounded-lg text-sm font-medium transition-colors"
                >
                  Send
                </button>
              </div>
