...
//           userRole: user.user_type || user.role || 'teacher'
//         };
//       }
//     } catch (error) {
//       console.error('Error parsing user data:', error);
//     }
//     // Fallback values for teacher
//     return {
//       userId: localStorage.getItem('teacher_id') || localStorage.getItem('user_id') || '1',
//       userRole: 'teacher'
//     };
//   };
...
//   // Debug logging
//   useEffect(() => {
//     console.log('Teacher GlobalAnnouncements - User Info:', { userId, userRole });
//   }, [userId, userRole]);
...
//       console.log('Teacher fetching announcements with params:', params.toString());
...
//     try {
//       console.log('Teacher marking as read for user:', { 
...
//                 announcement.is_read ? 'bg-white' : 'bg-blue-50 border-blue-200'
